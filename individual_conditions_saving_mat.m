...
% Create folder for workspace snapshots
snapshot_dir = 'D:/workspace_snapshots';
...
for i = 1:numel(file_list)
    ...
    % --- Save all workspace variables for this iteration
    snapshot_file = fullfile(snapshot_dir, sprintf('%s_workspace.mat', base_name));
    save(snapshot_file);
end
